    ...
    switch (_alignment) {
        case LegendAlignmentVertical:{
            [_data enumerateObjectsUsingBlock:^(LewLegendViewData * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
                ...
                [obj.label drawInRect:CGRectMake(Margin+RectWidth+Rect_TextMargin, Margin+idx*(LegendTextSize+LegendMargin)-2, self.bounds.size.width, LegendTextSize*2) withAttributes:@{NSFontAttributeName: [UIFont systemFontOfSize:LegendTextSize], NSForegroundColorAttributeName:[UIColor colorWithRed:67/255.0 green:77/255.0 blue:105/255.0 alpha:1.0]}];
            }];
            break;
        }
        case LegendAlignmentHorizontal:{
            ...
            [_data enumerateObjectsUsingBlock:^(LewLegendViewData * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
                ...
                [obj.label drawInRect:CGRectMake(x, Margin-2, size.width, self.bounds.size.height) withAttributes:@{NSFontAttributeName: [UIFont systemFontOfSize:LegendTextSize], NSForegroundColorAttributeName:[UIColor colorWithRed:67/255.0 green:77/255.0 blue:105/255.0 alpha:1.0]}];
